...
//    }
    ...
    void updateDeliveryStatus_ShouldUpdateStatus_WhenDeliveryExists() {
        ...
        Delivery delivery = mock(Delivery.class);
        when(deliveryRepository.findById(dto.getDeliveryId())).thenReturn(Optional.of(delivery));
    ...
    void updateDeliveryStatus_ShouldThrowException_WhenDeliveryNotFound() {
        ...
        when(deliveryRepository.findById(dto.getDeliveryId())).thenReturn(Optional.empty());
