...
const Footer = () => {
  return (
      <footer style={{ width: '100%', position: 'relative', marginTop: 'auto' }} className="bg-dark text-light py-4">
        <div className="row justify-content-center mt-4" style={{width:"100%"}}>
        ...
        <div className="row justify-content-center mt-2" style={{ display: 'flex', justifyContent: 'center', width:"100%" }}>
          <div className="col text-center">
