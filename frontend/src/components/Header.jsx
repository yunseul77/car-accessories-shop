      ...
      <header className="py-3 border-bottom">
        <div className="container d-flex flex-wrap justify-content-between align-items-center">
          ...
          <div className="d-flex gap-2 justify-content-end" style={{ flex: "0.72" }}>
             ...
             <button className="btn btn-primary me-md-2" type="button" style={{ display: "flex", flexDirection: "column", alignItems: "center", background: "none", border: "none" }} onClick={() => navigate('cart')}>
